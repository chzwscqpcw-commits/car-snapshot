---
title: "Dashboard Warning Lights Explained — What They Mean and What They Cost"
description: "A clear guide to UK dashboard warning lights — red vs amber vs green, the 12 most common symbols, what each one really means, and the typical cost to fix."
date: "2026-05-12"
lastModified: "2026-05-12"
keywords: ["dashboard warning lights", "car warning lights", "engine management light", "what does dashboard light mean", "dashboard symbols UK", "warning light cost to fix"]
author: "Free Plate Check"
faqItems:
  - question: "What do the different colours of dashboard warning lights mean?"
    answer: "Red lights indicate a serious fault — pull over and stop driving when safe to do so. Amber/yellow lights are advisories — there's a fault, but you can usually drive to a garage. Green and blue lights are simply information — they tell you that a system (headlights, indicator, cruise control) is active. The colour-coding is standardised across almost all car makes."
  - question: "Can I drive with the engine management light on?"
    answer: "Sometimes — but only briefly, and only if the light is steady amber. A flashing amber engine management light, or a red light of any kind, means stop. A steady amber light could be something minor like a loose fuel cap, or something serious like a misfire that's damaging your catalytic converter. Either way, get it diagnosed within days, not weeks."
  - question: "How much does it cost to fix a dashboard warning light?"
    answer: "It varies enormously. A loose fuel cap fixing the engine light costs £0. A new battery for a charging light is £80–£250. A failed catalytic converter is £400–£1,500. A failed turbo is £1,000–£2,500. The light only tells you the system involved — only diagnosis can tell you the cause and cost."
  - question: "Why does my warning light come on and then go off?"
    answer: "Intermittent lights usually point to an intermittent fault — a connector that loses contact when the car is cold, a sensor that misreads briefly, or a system that resets itself after the fault clears. The fault code is logged even when the light goes off, so a garage with a diagnostic tool can still see what triggered it. Don't assume a light that's gone away has fixed itself."
  - question: "Can a garage clear a warning light without fixing the problem?"
    answer: "Yes, and unfortunately some do. A diagnostic tool can clear any fault code temporarily — but if the underlying issue isn't fixed, the light will return within a few drive cycles. If you've paid for a 'repair' and the light is back within a week, the work wasn't done. Insist on seeing the replaced parts and ask for a printout of the fault codes before and after."
---
...
**Typical fix cost**: low brake fluid (£40 top-up + leak find), worn pads triggering sensor (£90–£350 — see our [brake pads guide](/repair-costs/brake-pads-replacement)).
...
**Typical fix cost**: forced regen £80–£150; full cleaning £150–£500; replacement £1,000–£3,500 (see our [DPF cleaning guide](/repair-costs/dpf-cleaning)).
...
**Typical fix cost**: new battery £80–£250 (see our [battery guide](/repair-costs/car-battery-replacement)); battery sensor £50–£120.
...
- [DPF cleaning cost guide](/repair-costs/dpf-cleaning) — for the diesel particulate filter light.
- [Brake pads replacement guide](/repair-costs/brake-pads-replacement) — for the brake wear warning.
- [Car battery replacement guide](/repair-costs/car-battery-replacement) — for the stop-start and battery warnings.
- [All UK car repair cost guides](/repair-costs) — see what every common repair should cost.
