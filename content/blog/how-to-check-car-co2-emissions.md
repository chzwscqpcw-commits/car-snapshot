---
title: "How to Check a Car's CO2 Emissions"
description: "How to find out a car's CO2 emissions, why they matter for road tax, ULEZ, and running costs, and what the figures actually mean."
date: "2026-02-26"
keywords: ["car CO2 emissions check", "check CO2 emissions by reg", "car emissions check", "CO2 emissions road tax", "vehicle emissions UK", "car CO2 rating"]
...
The quickest way is to enter your registration number on our [free car check](/car-check). You'll see the CO2 emissions figure (in g/km) recorded against your vehicle by the DVLA, along with the fuel type, engine size, and Euro emission standard.
...
You can see your vehicle's current tax status and what you're paying using our [tax check](/tax-check).
...
- **Consider your next car carefully** — Use our [free car check](/car-check) to compare CO2 figures across different vehicles you're considering
- **Check the road tax impact** — Higher CO2 means higher VED. See what you'd save with our [tax check](/tax-check)
- **Factor in ULEZ** — If you drive in London or other Clean Air Zones, a high-CO2 vehicle may also mean daily charges. Check with our [ULEZ check](/ulez-check)
...
- **Keep up with maintenance** — A well-serviced engine runs more efficiently. Check your [MOT history](/mot-check) for any advisories related to emissions or the exhaust system
...
Check yours in seconds with a [free car check](/car-check). Enter any UK registration number to see the CO2 figure alongside the full vehicle specification, [MOT history](/mot-check), [tax status](/tax-check), and [ULEZ compliance](/ulez-check) — all in one place, with no signup required.
