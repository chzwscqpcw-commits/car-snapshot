---
title: "Should I Buy a Car with MOT Advisories?"
description: "Not all MOT advisories are equal. Learn which ones to ignore, which to negotiate on, and which should make you walk away."
date: "2026-05-08"
keywords: ["buy car with MOT advisories", "MOT advisories used car", "are MOT advisories bad", "MOT advisory red flags", "should I worry about MOT advisories"]
author: "Free Plate Check"
faqItems:
  - question: "Should I buy a car with MOT advisories?"
    answer: "It depends on the type and pattern of advisories. Minor cosmetic notes like light surface rust are normal on older cars. But recurring advisories for suspension, brakes, or structural corrosion suggest neglected maintenance and potentially expensive repairs ahead."
  - question: "What MOT advisories should I worry about?"
    answer: "Advisories relating to structural corrosion, suspension component wear, brake pipe corrosion, and steering play are the most concerning. These tend to be expensive to fix and can become safety-critical if left unaddressed."
  - question: "Can I use MOT advisories to negotiate the price?"
    answer: "Yes. Advisories for items that will need replacing soon — such as worn suspension bushes, corroded springs, or tyres near the legal limit — give you legitimate grounds to negotiate. Get a quote for the work and factor it into your offer."
  - question: "Are recurring MOT advisories a red flag?"
    answer: "Yes. If the same advisory appears across two or more consecutive MOT tests, it usually means the owner hasn't addressed the issue. This is a strong indicator of neglected maintenance and suggests other work may have been skipped too."
  - question: "Do MOT advisories affect car value?"
    answer: "Significant advisories can reduce a car's value, particularly if they point to upcoming expensive repairs. Buyers and dealers both factor in the cost of remedial work when valuing a vehicle."
---
...
If you're not familiar with how advisories work, our guide on [what MOT advisories mean](/blog/what-does-mot-advisory-mean) covers the basics in detail.
...
- **Mileage inconsistencies alongside advisories** — if the mileage drops or stalls between tests and the car also has wear-related advisories, you may be looking at a clocked vehicle. Our guide on [how to spot a clocked car](/blog/how-to-spot-a-clocked-car) explains what to look for.
