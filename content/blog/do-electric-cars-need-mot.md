---
title: "Do Electric Cars Need an MOT?"
description: "Everything you need to know about MOTs for electric cars in the UK — what's tested, what's skipped, common EV issues, and what it costs."
date: "2026-03-22"
lastModified: "2026-03-22"
keywords: ["electric car MOT", "EV MOT test", "do EVs need MOT", "electric car MOT test", "Tesla MOT", "electric car MOT what's tested"]
author: "Free Plate Check"
faqItems:
  - question: "Do electric cars need an MOT?"
    answer: "Yes. Electric cars are subject to the same MOT requirement as petrol and diesel vehicles. They need their first MOT when they are three years old, and then every year after that."
  - question: "Is the MOT different for electric cars?"
    answer: "The MOT for an electric car follows the same structure but skips the exhaust emissions test, since EVs have no tailpipe. Everything else — brakes, tyres, lights, steering, suspension, bodywork — is tested as normal."
  - question: "How much does an MOT cost for an electric car?"
    answer: "The maximum MOT fee is the same as for any other car: £54.85. Since there is no emissions test, the actual test may be slightly quicker, but the fee is not usually reduced."
  - question: "Do Teslas need an MOT?"
    answer: "Yes. Teslas are subject to the same MOT rules as all other cars in the UK. A Tesla Model 3 registered new in 2023, for example, would need its first MOT by 2026. You can check any Tesla's MOT status and history using a free vehicle check tool."
  - question: "What are common MOT failures on electric cars?"
    answer: "The most common MOT failures on EVs are tyre wear (due to the heavy battery and instant torque), lighting faults, suspension wear from the extra weight, and seized brake components caused by light use of the friction brakes."
---
...
You can check any vehicle's current MOT status and full test history using our [free MOT check tool](/mot-check).
...
It's worth noting that while EVs skip the emissions test at the MOT, they are inherently compliant with clean air zones like London's ULEZ. If you're wondering whether your vehicle meets the ULEZ standard, you can check instantly with our [ULEZ check tool](/ulez-check).
