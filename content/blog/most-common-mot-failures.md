---
title: "Most Common MOT Failures and How to Avoid Them"
description: "The top 10 reasons cars fail the MOT in the UK, what testers are looking for in each category, and a practical pre-MOT checklist so you can spot problems before the test does."
date: "2026-03-18"
lastModified: "2026-03-18"
keywords: ["common MOT failures", "MOT failure reasons", "why cars fail MOT", "MOT fail list UK", "most common MOT faults", "how to pass MOT"]
author: "Free Plate Check"
faqItems:
  - question: "What is the most common reason for failing an MOT?"
    answer: "Lighting and signalling is consistently the single biggest cause of MOT failures in the UK. This includes blown bulbs, misaligned headlights, cracked lenses, and faulty indicators. It's also one of the easiest things to check and fix yourself before the test."
  - question: "How many cars fail their MOT each year?"
    answer: "Roughly one in three vehicles tested in the UK fails the MOT. Many of these failures are for relatively minor, easily preventable issues such as blown bulbs, worn wiper blades, or low tyre tread."
  - question: "Can you fail an MOT for a dirty car?"
    answer: "A dirty car won't fail the MOT, but excessive dirt can prevent the tester from properly inspecting components like the registration plates, lights, or bodywork. If the tester can't see what they need to check, they may refuse to complete the test until the vehicle is clean enough."
  - question: "What should I check on my car before an MOT?"
    answer: "Walk around the car and check all lights, indicators, and brake lights. Check tyre tread depth (minimum 1.6mm), tyre condition, windscreen for chips or cracks, wiper blades, mirrors, seatbelts, the horn, and that your registration plates are clean and legible."
  - question: "Can you fix a failed MOT item and get a free retest?"
    answer: "If repairs are carried out at the same testing station and the car is retested within 10 working days, the partial retest on the failed items is usually free. Policies vary by garage, so always confirm before leaving."
---
