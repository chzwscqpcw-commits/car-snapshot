...
description: "How long an MOT test actually takes, what the tester checks, what affects the duration, and what to do if your car fails — a practical guide for UK drivers."
date: "2026-03-20"
lastModified: "2026-03-20"
keywords: ["how long does MOT take", "MOT test duration", "how long is MOT test", "MOT test time", "how long for an MOT", "MOT waiting time"]
author: "Free Plate Check"
faqItems:
  - question: "How long does an MOT test take?"
    answer: "A standard MOT test typically takes between 45 and 60 minutes. However, this can vary depending on the vehicle type, its age and condition, and how busy the test centre is."
  - question: "Can I wait at the garage during my MOT?"
    answer: "Most garages allow you to wait in a reception area while your MOT is carried out. Some have viewing areas where you can watch the test. Alternatively, you can drop the car off and collect it later."
  - question: "What happens if my car fails the MOT?"
    answer: "If your car fails, you'll receive a list of the items that need to be repaired. If the same garage does the repairs and retests within 10 working days, the partial retest is often free or significantly cheaper. If a dangerous defect is found, the car must not be driven until it is repaired."
  - question: "How much does an MOT cost?"
    answer: "The maximum fee for a car MOT is £54.85, but many garages charge less. Prices vary by location and garage, so it's worth comparing a few options before you book."
  - question: "Can I get an MOT done early?"
    answer: "Yes. You can have your MOT done up to one month (minus a day) before the expiry date without losing any days on the new certificate. The new certificate will run from the old expiry date."
---
