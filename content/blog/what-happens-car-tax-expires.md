---
title: "What Happens if Your Car Tax Expires?"
description: "What actually happens when your car tax runs out in the UK — fines, penalties, clamping, ANPR enforcement, and how to sort it before things escalate."
date: "2026-03-24"
lastModified: "2026-03-24"
keywords: ["car tax expired", "expired road tax", "driving without tax", "car tax penalty", "untaxed car fine", "what happens if car tax runs out"]
author: "Free Plate Check"
faqItems:
  - question: "What is the fine for expired car tax?"
    answer: "The DVLA issues an automatic late licensing penalty of £80 if you do not renew your tax or declare a SORN. If the case goes to court, you can be fined up to £1,000. Your vehicle may also be clamped or impounded."
  - question: "Can you drive a car with expired tax?"
    answer: "No. Driving an untaxed vehicle on a public road is illegal in the UK. There is no grace period after your tax expires. If you are caught, you can be fined and the vehicle may be clamped or seized."
  - question: "Will I get caught if my car tax expires?"
    answer: "Very likely, yes. The DVLA uses ANPR (automatic number plate recognition) cameras across the UK road network. These cameras automatically flag untaxed vehicles and can trigger enforcement action without a police officer pulling you over."
  - question: "Can the DVLA clamp my car for no tax?"
    answer: "Yes. The DVLA can clamp an untaxed vehicle wherever it is found, including on a public road or in a car park. To release a clamped vehicle, you must pay the release fee (£100), retax the vehicle, and pay any outstanding penalties. If the vehicle is not claimed, it can be crushed."
  - question: "How do I retax my car after it expires?"
    answer: "You can retax your vehicle online at GOV.UK, by phone, or at a Post Office. You will need a valid MOT and valid insurance before the DVLA will allow you to tax the vehicle. If you do not want to use the car, you can declare a SORN instead."
---
...
You can check whether any vehicle is currently taxed using our [free tax check tool](/tax-check).
...
The simplest step is knowing when it's due. You can check any vehicle's tax expiry date instantly with our [tax check tool](/tax-check) — it takes a few seconds.
