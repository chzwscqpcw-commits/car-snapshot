...
The easiest way to find out what a specific vehicle pays in road tax is to look it up by registration number. Our [tax check tool](/tax-check) shows the current tax status, and you can see the vehicle's fuel type, CO2 emissions, and registration date — all the information you need to work out the VED band.
