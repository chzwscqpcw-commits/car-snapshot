---
title: "How to SORN a Car Online — Step-by-Step Guide"
description: "How to declare a SORN on your vehicle, when you need one, and what the rules are. A quick guide to the Statutory Off Road Notification process."
date: "2026-02-21"
...
You can check whether a vehicle is currently taxed or SORN'd using our [tax check](/tax-check).
...
If you buy a vehicle that is SORN'd, the SORN continues. You must tax it (and ensure it has a valid [MOT](/mot-check) if over 3 years old) before driving it on any public road.
...
Before ending a SORN by taxing the vehicle, make sure it has a valid MOT (if over 3 years old). You can check this using our [MOT check](/mot-check). The DVLA won't let you tax without a valid MOT.
