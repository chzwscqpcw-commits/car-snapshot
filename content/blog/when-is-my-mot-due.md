...
The quickest way is to enter your registration number on our [MOT check tool](/mot-check). You'll see your current MOT status, the expiry date, and the full test history.
...
Your MOT due date is easy to check and easy to forget. Take 30 seconds to [look it up](/mot-check) now, set a reminder for a month before, and book with time to spare. It's a small habit that keeps you legal, keeps you safe, and avoids the stress of a last-minute scramble.
