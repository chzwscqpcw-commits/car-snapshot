...
Cars with good safety ratings and advanced driver assistance systems (autonomous emergency braking, lane assist, etc.) can receive a lower group rating. Check a vehicle's safety credentials with our [free car check](/car-check) — we include Euro NCAP ratings where available.
...
1. **Run a [free car check](/car-check)** to confirm the exact make, model, variant, and engine size
2. **Look up the insurance group** on Thatcham's website or comparison sites like GoCompare or Confused.com
3. **Get actual quotes** before committing to a purchase — the same model with a different engine or trim can be in a very different group
...
Start with a [free car check](/car-check) to confirm the exact vehicle specification, check its [MOT history](/mot-check) and [mileage](/mileage-check), then use that information to get accurate insurance quotes. A few minutes of research can save hundreds of pounds a year on your premium.
