---
title: "Car Insurance Groups 1–50: The Complete UK Guide (2026)"
description: "How UK car insurance groups are decided, which models sit in each band, why EVs land higher than expected, and how to use the group rating to find cheaper cover."
date: "2026-03-04"
lastModified: "2026-05-29"
keywords: ["car insurance groups", "insurance group 1", "cheapest cars to insure", "car insurance group check", "how insurance groups work", "used car insurance cost", "buying a car insurance", "EV insurance groups", "Thatcham insurance group", "insurance group by model"]
author: "Free Plate Check"
faqItems:
  - question: "What insurance group is the cheapest?"
    answer: "Group 1 is the cheapest insurance group in the UK. Cars that typically sit in groups 1–3 include the Volkswagen up! 1.0, Hyundai i10 1.0 SE, Kia Picanto 1.0, Citroen C1 and base-trim Dacia Sandero. They share the same profile: small engines, low repair bills, cheap parts and a low risk of being involved in a serious crash. A driver in group 1 will often pay £400–£600 less per year than the same driver in group 20."
  - question: "Can I lower my insurance group?"
    answer: "No. The insurance group is fixed for the life of the vehicle by the Group Rating Panel and cannot be reduced by the owner. What you can change is how an insurer prices that group for you — by building no-claims discount, keeping mileage low, parking off-road, paying annually, increasing voluntary excess, or moving to a telematics policy. If you want a lower group, you have to change car."
  - question: "Do modifications affect insurance group?"
    answer: "Modifications do not change the official group rating, but they almost always increase your premium and can void the policy if undeclared. Engine remaps, larger alloys, suspension changes and aftermarket exhausts are the highest-impact. Even neutral-sounding additions — hardwired dashcams, non-Thatcham alarms, parking sensors retrofitted into the bumper — must be declared. Failing to declare anything fitted to the car after it left the factory can leave you uninsured at the moment of a claim."
  - question: "Are EVs cheaper to insure?"
    answer: "Generally no. Most mainstream EVs sit in groups 25–40 — higher than equivalent petrol cars — because the battery pack is expensive to repair after even minor impacts and many EVs have advanced sensors built into the bumpers and wings. The Tesla Model 3 sits around group 48, the MG4 around group 27, and the Nissan Leaf around group 22. Running costs are lower thanks to cheap home charging, but the insurance premium typically offsets some of that saving."
  - question: "What is the difference between group 1 and group 10?"
    answer: "Both are considered cheap to insure, but the gap matters for younger drivers. A group 1 car like the Volkswagen up! has the smallest engine, the cheapest parts and the lowest performance, so insurers price it as the lowest possible risk. A group 10 car like the Ford Fiesta 1.0 EcoBoost is slightly faster, has more equipment to damage and slightly higher repair costs. For a 30-year-old in a mid-risk postcode the difference is typically £150–£250 a year; for a 19-year-old it can be £600 or more."
  - question: "How often are insurance groups updated?"
    answer: "The Group Rating Panel meets monthly to assess new and updated models. Once a car is assigned a group, it generally stays in that group for its whole life — even as it ages and depreciates. Occasionally a facelift, a new safety system or a sharp change in parts pricing can move a model up or down, but for the vast majority of used cars the group you see today is the group it will keep."
  - question: "Why is my car in a higher group than I expected?"
    answer: "The single biggest reason is parts cost. Modern cars carry radar, cameras and bonded glass that turn a minor bump into a four-figure repair, and the Group Rating Panel reflects that. Trim and engine variant matter too — an Audi A3 1.5 TFSI sits around group 19, but the S3 jumps into the high 30s. EVs, plug-in hybrids and anything with a large factory-fitted infotainment screen also tend to score higher than their size or performance would suggest."
  - question: "Does the insurance group decide my premium on its own?"
    answer: "No. The group is one input among many. Insurers weigh your postcode, age, occupation, claim history, annual mileage, where the car sleeps overnight and whether you have any convictions far more heavily than the group number alone. Two drivers in identical group 15 cars can be quoted £450 and £1,800 — both correct — because everything else around the car is different."
---

Every car sold in the UK is assigned an insurance group between 1 and 50. Group 1 is the cheapest to insure, group 50 the most expensive. If you are choosing a used car on a budget, the group rating can be the difference between affordable cover and a quote that costs more than the car itself.
...
Euro NCAP rating, autonomous emergency braking (AEB), lane assist, blind-spot monitoring and similar systems can pull a car down the table. AEB in particular has measurable claims-cost benefits. You can see the Euro NCAP star rating for any UK car on our [free car check](/car-check) — the panel uses the same underlying ratings as one of its inputs.
...
If you are insuring a new driver, anything in this band is a safe starting point. Pair the low group with a telematics policy and the premium can drop further again. Most of these cars also sit in the cheapest [VED bands and have low running costs](/tax-check) generally, so the savings compound.
...
Trim matters a lot in this band. A Ford Focus 1.0 Titanium can sit around group 14, but the ST-Line with sportier suspension, bigger wheels and extra body trim moves up several groups even though the engine is identical. Always check the [exact variant of any used car](/car-check) before getting quotes — the same nameplate on different trims can sit five or more groups apart.
...
If you are weighing up an EV against a petrol equivalent, factor the insurance gap into the total cost — the [running-cost saving on electricity](/blog/petrol-vs-diesel-vs-hybrid-vs-electric) can still come out ahead, but it is closer than the headlines suggest.
...
1. **Confirm the exact variant.** Trim, engine size and gearbox can all shift the group. Run the registration on our [free car check](/car-check) to see the exact factory specification, including Euro NCAP rating where available — both are inputs the panel uses.
...
4. **Factor in running costs.** A cheaper-to-insure car is usually cheaper to tax and fuel as well, but not always — the [valuation and depreciation profile](/car-valuation) of a car affects the total cost of ownership more than insurance alone in many cases.
5. **Plan the first service.** A pre-purchase service history check and a fresh service straight after purchase do not change the group, but they reduce the chance of a costly claim — which is what protects your no-claims discount, which is what controls your future premium. Compare local garage prices on [BookMyGarage](/booking) before you commit.
...
Want to check the insurance group of a specific car before you buy? Enter the reg on our free [Car Checker](/car-check) to see the exact make, model, variant and Euro NCAP rating — the same factory data the Group Rating Panel uses as its starting point.
