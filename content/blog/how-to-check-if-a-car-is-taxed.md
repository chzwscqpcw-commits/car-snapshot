...
1. You can check any vehicle's tax status for free using just the registration number.
2. Tax doesn't transfer when a car is sold — the buyer must tax it themselves.
3. Driving untaxed can result in fines, clamping, or impounding.
4. You need a valid MOT before you can tax a vehicle.
5. Set a reminder before your tax is due — there's no grace period.
