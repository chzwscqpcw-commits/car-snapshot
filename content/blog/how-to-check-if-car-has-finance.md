...
A [free car check](/car-check) will show you the vehicle's DVLA data, [MOT history](/mot-check), [tax status](/tax-check), and [mileage records](/mileage-check) — all useful for spotting other problems. However, **finance data is not available through free government APIs**. No free tool can tell you definitively whether a car has outstanding finance.
...
1. **Contact the seller** — Ask them to settle the finance immediately. If they refuse, this may constitute fraud.
2. **Contact the finance company** — Explain the situation. They may be willing to negotiate, especially if the seller has disappeared.
3. **Report it to the police** — If the seller knowingly sold a financed car without disclosing it, report it to Action Fraud (0300 123 2040).
4. **Seek legal advice** — You may have a claim against the seller under the Hire Purchase Act or through the small claims court.
5. **Contact Citizens Advice** — They can help you understand your rights and next steps.
...
**Start with a free check.** Use our [free car check](/car-check) to verify the vehicle details, [MOT history](/mot-check), and [mileage](/mileage-check). If anything looks suspicious, that's your cue to investigate further before spending money on a paid check.
...
Outstanding finance is one of the few risks that a free car check cannot fully cover — finance data sits in private databases, not government APIs. For any used car costing more than a few hundred pounds, a paid vehicle history report — such as a **[carVertical report](https://www.carvertical.deal/NCRBZ8/6JHXF/?source_id=AFF&sub1=freeplatecheck&sub2=blog)** — is the cheapest insurance you'll ever buy. For the full buying checklist, see our guide to [essential checks before buying a used car](/blog/used-car-checks-before-buying).
