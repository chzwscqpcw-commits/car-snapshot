---
title: "What Is a V5C Logbook? Everything You Need to Know"
description: "What the V5C logbook is, what it shows, why it matters when buying or selling a car, and how to get a replacement if yours is lost or stolen."
date: "2026-02-19"
keywords: ["V5C logbook", "what is a V5C", "car logbook", "V5C registration certificate", "V5C document", "vehicle logbook UK"]
...
You can verify much of this information independently using a [free car check](/car-check) — enter the registration number to see the DVLA data and confirm it matches the V5C.
...
Cross-reference the V5C details with a [free car check](/car-check). If the DVLA data doesn't match the V5C, something is wrong.
...
1. The seller fills in the green slip with your details
2. The seller gives you the green slip
3. The seller posts the rest of the V5C to the DVLA (or updates online)
4. The DVLA sends you a new V5C in your name within 2–4 weeks
...
- **Tax the vehicle** — Online at GOV.UK or at the Post Office. Check your current [tax status](/tax-check).
...
The V5C is a straightforward document once you understand what it does and doesn't prove. Always check it when buying a car, always update it when selling, and cross-reference the details with a [free car check](/car-check) to make sure everything matches.

If you're about to buy a used car, run a check on the registration number first. It takes 30 seconds and confirms the vehicle details, [MOT history](/mot-check), [tax status](/tax-check), and [mileage records](/mileage-check) — all of which should align with what the V5C shows.
