---
title: "What to Do if Your Car Fails Its MOT"
description: "Your car has failed its MOT — now what? A practical guide to your options, your rights, and how to get back on the road as quickly and cheaply as possible."
date: "2026-02-24"
keywords: ["car failed MOT", "MOT failure what to do", "failed MOT options", "MOT retest", "MOT failure repairs", "car failed MOT can I drive"]
...
You can also look up the full [MOT history](/mot-check) for your vehicle online to see past results, advisories, and how the current failure compares to previous tests.
...
If the repair costs are more than the vehicle is worth, it may make more sense to sell it for salvage or scrap it through an Authorised Treatment Facility. Check our [free car valuation](/car-valuation) to see what the vehicle would be worth in good condition, and weigh that against the repair estimate.
...
1. **Lights and signalling** — Blown bulbs, misaligned headlights, damaged lenses. The single most common failure category.
2. **Suspension** — Worn bushes, damaged shock absorbers, excessive play in joints.
3. **Brakes** — Worn pads or discs, binding calipers, imbalanced braking.
4. **Tyres** — Below minimum tread depth (1.6mm), damage, or incorrect fitment.
5. **Driver's view** — Windscreen chips or cracks in the critical zone, wiper faults.
