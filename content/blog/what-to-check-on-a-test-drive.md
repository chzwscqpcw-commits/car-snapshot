---
title: "What to Check on a Test Drive: A Complete Checklist"
description: "Everything to check when test driving a used car — engine, brakes, steering, gearbox, electrics, and the warning signs that should make you walk away."
date: "2026-03-10"
keywords: ["test drive checklist", "what to check on test drive", "buying a used car test drive", "used car test drive tips", "car test drive checklist UK", "how to test drive a car"]
...
Before you even view the car, run a [free car check](/car-check) to review:

- **[MOT history](/mot-check)** — Look for recurring failures or advisories, especially on brakes, suspension, and steering. These tell you what's likely to go wrong.
- **[Mileage records](/mileage-check)** — Check for consistency. If the odometer doesn't match the MOT history, walk away.
- **[Tax status](/tax-check)** — An untaxed vehicle shouldn't be on the road, and driving it on a test drive is technically illegal.
- **[Safety recalls](/recall-check)** — Any outstanding recalls should be addressed before purchase.
...
- Mileage on the dash doesn't match the [MOT records](/mileage-check)
...
Before viewing any car, run a [free car check](/car-check) to review the [MOT history](/mot-check), [mileage trail](/mileage-check), [tax status](/tax-check), [recall history](/recall-check), and [estimated value](/car-valuation). Arrive informed, test systematically, and trust what the car tells you on the road.
