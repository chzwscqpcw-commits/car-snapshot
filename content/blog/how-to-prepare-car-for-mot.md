---
title: "How to Prepare Your Car for Its MOT — The Complete Checklist"
description: "A practical pre-MOT checklist covering everything testers look for, what you can fix yourself, and how to avoid common failures."
date: "2026-04-10"
keywords: ["how to prepare car for MOT", "MOT checklist", "pre-MOT check", "MOT preparation", "how to pass MOT", "MOT test checklist UK"]
author: "Free Plate Check"
faqItems:
  - question: "What should I check before taking my car for an MOT?"
    answer: "Check all lights and indicators, tyre tread depth (minimum 1.6mm) and condition, windscreen for cracks, wiper blades, mirrors, seatbelts, the horn, number plate condition, and fluid levels. Also check that your dashboard warning lights go off after starting the engine."
  - question: "Can I fix things myself before the MOT?"
    answer: "Yes — many common MOT failures are simple fixes. You can replace bulbs, wiper blades, and fuses yourself. You can top up washer fluid, check tyre pressures, and clean your number plates. More involved work like brake pad replacement or suspension repairs is best left to a mechanic."
  - question: "How much does it cost to get an MOT?"
    answer: "The maximum fee for a standard car MOT is £54.85 (2026). Many garages charge less, and some offer MOTs from around £30–£40. You can compare garage prices online to find the best deal near you."
  - question: "What are the most common reasons for MOT failure?"
    answer: "The top failure reasons are lighting faults (blown bulbs, misaligned headlights), tyre issues (low tread, damage), suspension problems, brake defects, and driver visibility issues (wipers, washers, windscreen damage). Many of these are preventable with a quick check beforehand."
  - question: "Do MOT advisories need to be fixed before the next test?"
    answer: "Advisories are not failures — your car still passes with them. However, they flag developing issues that may become failures by the next test. Addressing advisories promptly is both safer and cheaper than waiting for them to worsen."
  - question: "Can I get my MOT done early?"
    answer: "Yes. You can have your MOT done up to one month (minus a day) before the current one expires, and the new certificate will run from the old one's expiry date. This means you don't lose any time by testing early."
---
...
Run a [free MOT check](/mot-check) to see your full MOT history, including every advisory and failure from previous tests. Our MOT readiness score highlights the items most likely to cause problems at your next test.
...
If it fails, you have the right to a free partial retest if repairs are done at the same garage within 10 working days. Read our guide on [what to do if your car fails its MOT](/blog/what-to-do-if-car-fails-mot) for your options.

## Check your MOT history now

Start your preparation by checking what testers found last time. Run a [free MOT check](/mot-check) to see your complete test history, including every advisory and failure. You can also see when your next MOT is due and check your [car's tax status](/tax-check) while you're at it.

For a deeper look at what each advisory actually means, see our guide to [MOT advisories explained](/blog/what-does-mot-advisory-mean). And if you want to understand the most common failure points across all vehicles, check out [the most common MOT failures](/blog/most-common-mot-failures).
