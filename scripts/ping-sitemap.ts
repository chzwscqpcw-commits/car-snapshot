...
const URLS = [
  ...
  `https://${HOST}/cheap-mot`,
  `https://${HOST}/blog/how-to-get-a-cheaper-mot`,
  `https://${HOST}/blog/are-cheap-mot-deals-worth-it`,
  `https://${HOST}/blog/cheapest-place-to-get-mot`,
  `https://${HOST}/blog/free-mot-how-to-get-one`,
