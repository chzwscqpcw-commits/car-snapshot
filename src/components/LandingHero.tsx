      ...
      <div className="relative max-w-5xl mx-auto px-4 pt-8 pb-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          {/* Example card — only rendered ≥lg. On mobile/tablet it took up
              ...
              for a real result. A small framed screenshot thumbnail
              (previewImage prop) shows below on mobile instead. */}
          <div className="hidden lg:block card-zoom-wrapper mx-auto lg:mx-0">
            {exampleCard}
          </div>
        </div>

        {/* Mobile-only thumbnail: a small tilted screenshot of the actual
            result UI, clearly labelled "Sample". Generated by
