...
interface LandingHeroProps {
   ...
   *  on mobile only. Generated by scripts/generate-previews.ts. */
  previewImage?: string;
}
  ...
  return (
    <div className="relative overflow-hidden border-b border-slate-800 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950">
      ...
      <div className="relative max-w-5xl mx-auto px-4 pt-8 pb-6 lg:pb-10">
        ...
        {/* Mobile-only preview screenshot — absolutely positioned in the
            top-right corner of the hero so it sits behind the headline/
            bullets without taking its own vertical block. */}
        {previewImage && (
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center relative z-10">
          ...
          {/* Desktop preview — uses the real generated screenshot if a
              previewImage is provided; falls back to the hand-coded
              exampleCard for legacy callers. */}
          {previewImage ? (
