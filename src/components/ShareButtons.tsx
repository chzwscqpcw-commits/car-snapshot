  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <a
        ...
        className={`${buttonClass} border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-slate-100`}
      ...
      >
        {copied ? (
          <>
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-none stroke-current" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
