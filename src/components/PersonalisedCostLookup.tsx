          ...
          <>
            <div className="mt-5 border-t border-slate-800 pt-5">
              ...
              <a
                ...
                className="mt-3 inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-emerald-600"
              >
